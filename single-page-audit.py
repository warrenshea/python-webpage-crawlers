...
class Crawler():
    crawl_page_en = "https://www.domain.com/en/"
    crawl_page_fr = "https://www.domain.com/fr/"

    chromedriver = '/usr/local/bin/chromedriver'
    driver = webdriver.Chrome(chromedriver)

    def __init__(self):
        workbook = xlsxwriter.Workbook('single-page-audit.xlsx')
    ...
    def crawl_url(self, workbook, crawl_page, lang):
        ...
        for anchor in soup.main.find_all('a'):
